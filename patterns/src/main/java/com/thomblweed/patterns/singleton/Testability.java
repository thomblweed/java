package com.thomblweed.patterns.singleton;
...
class SingletonDatabase {
  ...
  private SingletonDatabase() {
    ...
    try {
      File f =
          new File(Testability.class.getProtectionDomain().getCodeSource().getLocation().getPath());
...
class Testability {
  ...
  public void singletonTotalPopulationTest() {
    // testing on a live database, not a unit test
